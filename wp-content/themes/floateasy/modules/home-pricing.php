			...
			<div class="homepricing-member-grid homepricing-module-grid">
				...
				<div class="homepricing-member-grid-item homepricing-module-grid-item">
					<div class="homepricing-member-grid-item-content homepricing-module-grid-item-content">
						<h3 class="homepricing-member-grid-item-content-price homepricing-module-grid-item-content-price">Free!</h3>
						<p class="homepricing-member-grid-item-content-description homepricing-module-grid-item-content-description">1<sup>st</sup> Month!</p>
					</div>
				</div>
				...
				<div class="homepricing-member-grid-item homepricing-module-grid-item">
					<div class="homepricing-member-grid-item-content homepricing-module-grid-item-content">
						<!-- <h3 class="homepricing-member-grid-item-content-price homepricing-module-grid-item-content-price">Incredible Value</h3> -->
						<p class="homepricing-member-grid-item-content-description homepricing-module-grid-item-content-description">Pay Month to Month</p>
						<p class="homepricing-member-grid-item-content-description homepricing-module-grid-item-content-description">Floats roll forward FOREVER</p>
						<p class="homepricing-member-grid-item-content-description homepricing-module-grid-item-content-description">Shareable Floats with unlimited friends</p>
