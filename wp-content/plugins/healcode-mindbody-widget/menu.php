...
function hc_hmw_menu(){
    /* Adding Main Menu */
	add_menu_page('healcode-mb-widget', 'MB Widgets', 'manage_options', 'insert-html-short-manage','hc_hmw_snippets',plugins_url('healcode-mindbody-widget/images/mblogo.png'));
