...
<div >
	<fieldset
		...
		<div class="hc-widget-code-example">
			Title your Widget - this is for your reference only - and then paste the widget code in the form below. </br>
			To get your widget code, in your MINDBODY Widget Manager, select a widget and scroll to the bottom of the settings page.
			<div class="hc-add-widget">
				<img src="<?php echo plugins_url('healcode-mindbody-widget/images/hc-widget-code-example.png')?>" alt="widget code example">
			</div>
		</div>
		<form name="frmmainForm" id="frmmainForm" method="post">
			...
			<div>
				<table
					...
					<br/></td></tr>
					<tr valign="top">
						<td style="border-bottom: none;width:20%; text-align: right;">&nbsp;&nbsp;&nbsp;Widget Title&nbsp;<font color="red">*</font> </td>
					...
					<tr>
						<td style="border-bottom: none;width:20%; text-align: right; ">&nbsp;&nbsp;&nbsp;Widget Code&nbsp;<font color="red">*</font> </td>
						<td style="border-bottom: none;width:1px;">&nbsp;:&nbsp;</td>
						<td >
